...
export const TRANSACTIONS: Transaction[] = [
  { id: 'VX7A8201', type: 'debit', category: 'Food', merchant: 'Swiggy', detail: 'Dinner · Butter Chicken & Naan', amount: 420, date: '2026-08-11', time: '7:32 PM', method: 'Card', status: 'Completed', fee: 0, balanceAfter: 48520.4 },
  { id: 'VX7A8202', type: 'credit', category: 'Transfer', merchant: 'Rahul Sharma', detail: 'Transfer received', amount: 1500, date: '2026-08-11', time: '1:05 PM', method: 'UPI', status: 'Completed', fee: 0, balanceAfter: 48940.4 },
  { id: 'VX7A8203', type: 'debit', category: 'Entertainment', merchant: 'Netflix', detail: 'Monthly subscription', amount: 649, date: '2026-08-10', time: '9:15 PM', method: 'Autopay', status: 'Completed', fee: 0, balanceAfter: 47440.4 },
  { id: 'VX7A8204', type: 'debit', category: 'Food', merchant: 'Zomato', detail: 'Lunch · Biryani', amount: 384, date: '2026-08-10', time: '8:41 PM', method: 'Card', status: 'Completed', fee: 0, balanceAfter: 48089.4 },
  { id: 'VX7A8205', type: 'debit', category: 'Groceries', merchant: 'Blinkit', detail: 'Weekly groceries', amount: 612, date: '2026-08-09', time: '11:20 AM', method: 'UPI', status: 'Completed', fee: 0, balanceAfter: 48473.4 },
  { id: 'VX7A8206', type: 'debit', category: 'Transport', merchant: 'Uber', detail: 'Airport → Indiranagar', amount: 268, date: '2026-08-09', time: '9:04 AM', method: 'Card', status: 'Completed', fee: 0, balanceAfter: 49085.4 },
  { id: 'VX7A8207', type: 'debit', category: 'Shopping', merchant: 'Amazon', detail: 'Wireless headphones', amount: 1299, date: '2026-08-08', time: '4:47 PM', method: 'Card', status: 'Completed', fee: 0, balanceAfter: 49353.4 },
  { id: 'VX7A8208', type: 'debit', category: 'Entertainment', merchant: 'Spotify', detail: 'Monthly subscription', amount: 119, date: '2026-08-08', time: '7:12 AM', method: 'Autopay', status: 'Completed', fee: 0, balanceAfter: 50652.4 },
  { id: 'VX7A8209', type: 'debit', category: 'Transfer', merchant: 'Arjun Kapoor', detail: 'Sent · Movie tickets', amount: 2000, date: '2026-08-07', time: '6:30 PM', method: 'UPI', status: 'Completed', fee: 0, balanceAfter: 50771.4 },
  { id: 'VX7A8210', type: 'debit', category: 'Bills', merchant: 'BESCOM', detail: 'Electricity bill · Aug', amount: 1845, date: '2026-08-06', time: '10:12 AM', method: 'NetBanking', status: 'Completed', fee: 0, balanceAfter: 52771.4 },
  { id: 'VX7A8211', type: 'debit', category: 'Transfer', merchant: 'Karan Verma', detail: 'Split · Groceries share', amount: 1200, date: '2026-08-05', time: '9:48 PM', method: 'UPI', status: 'Completed', fee: 0, balanceAfter: 54616.4 },
  { id: 'VX7A8212', type: 'credit', category: 'Transfer', merchant: 'Ananya Mehta', detail: 'Request paid · Coffee run', amount: 750, date: '2026-08-05', time: '3:20 PM', method: 'UPI', status: 'Completed', fee: 0, balanceAfter: 55816.4 },
  { id: 'VX7A8213', type: 'debit', category: 'Groceries', merchant: 'BigBasket', detail: 'Monthly pantry restock', amount: 1540, date: '2026-08-03', time: '6:15 PM', method: 'Card', status: 'Completed', fee: 0, balanceAfter: 55066.4 },
  { id: 'VX7A8214', type: 'credit', category: 'Bills', merchant: 'Acme Corp', detail: 'Salary · August', amount: 45000, date: '2026-08-01', time: '9:00 AM', method: 'NetBanking', status: 'Completed', fee: 0, balanceAfter: 56606.4 },
  { id: 'VX7A8215', type: 'debit', category: 'Bills', merchant: 'Airtel', detail: 'Broadband + mobile', amount: 899, date: '2026-07-31', time: '8:30 AM', method: 'Autopay', status: 'Completed', fee: 0, balanceAfter: 11606.4 },
  { id: 'VX7A8216', type: 'debit', category: 'Food', merchant: 'Third Wave Coffee', detail: 'Cold brew', amount: 340, date: '2026-07-30', time: '5:40 PM', method: 'Card', status: 'Completed', fee: 0, balanceAfter: 12505.4 },
  { id: 'VX7A8217', type: 'debit', category: 'Bills', merchant: 'Rent · Indiranagar', detail: 'House rent · Aug', amount: 14000, date: '2026-07-29', time: '8:00 AM', method: 'NetBanking', status: 'Completed', fee: 0, balanceAfter: 12845.4 },
  { id: 'VX7A8218', type: 'debit', category: 'Entertainment', merchant: 'PVR Cinemas', detail: 'Movie · 2 tickets', amount: 500, date: '2026-07-28', time: '8:20 PM', method: 'Card', status: 'Completed', fee: 0, balanceAfter: 26845.4 },
  { id: 'VX7A8219', type: 'credit', category: 'Transfer', merchant: 'Rohan Verma', detail: 'Transfer received', amount: 2000, date: '2026-07-25', time: '2:15 PM', method: 'UPI', status: 'Completed', fee: 0, balanceAfter: 27345.4 },
  { id: 'VX7A8220', type: 'debit', category: 'Health', merchant: 'PharmEasy', detail: 'Medicines', amount: 760, date: '2026-07-24', time: '7:05 PM', method: 'UPI', status: 'Completed', fee: 0, balanceAfter: 25345.4 },
]
